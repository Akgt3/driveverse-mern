      ...
      <div className="max-w-[900px] mx-auto px-6 py-16">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input placeholder="Kilometers Driven" value={km} onChange={(e) => setKm(e.target.value)} />
            <input
  ...
  "
    ...
    "
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Select label="Transmission" options={["Manual", "Automatic", "CVT", "Robotic", "iMT", "AMT"]} value={transmission} onChange={(e) => setTransmission(e.target.value)} />

            <Select label="Number of Owners" options={["First", "Second", "Third", "More than Three"]} value={owners} onChange={(e) => setOwners(e.target.value)} />

            <Select label="Fuel Type" options={["Petrol", "Diesel", "Electric", "Hybrid", "CNG"]} value={fuel} onChange={(e) => setFuel(e.target.value)} />

            < Select label="Body Type" options={["Hatchback", "Sedan", "SUV", "Coupe", "Convertible", "Pickup", "Van", "MUV"]} value={body} onChange={(e) => setBody(e.target.value)} />
          ...
          <div>
            ...
            <label
              className="
                ...
                w-full h-[120px]
                border border-dashed border-gray-300 dark:border-[#333333]
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-neutral-400 mt-1">{desc}</p>
      </div>
    </button>
  );
}
